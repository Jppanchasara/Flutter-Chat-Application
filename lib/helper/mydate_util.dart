...
class MyDateUtil{
  //for getting formatted time from milliseconds sinceEpoch String
  ...
  //for getting formatted time for read & sent
  ...
  //get formatted last active time of user on chat screen
